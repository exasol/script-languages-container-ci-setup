...
def test_with_next_token():
    expected_list_stack_resources_result = ListStackResourcesResult(
    ...
    list_stack_resources_result = ListStackResourcesResult.from_boto(
        boto_list_stack_resources_result
    )
...
def test_with_next_token_none():
    expected_list_stack_resources_result = ListStackResourcesResult(
        next_token=None, stack_resource_summaries=[]
    )
    boto_list_stack_resources_result = {"NextToken": None, "StackResourceSummaries": []}
    list_stack_resources_result = ListStackResourcesResult.from_boto(
        boto_list_stack_resources_result
    )
    assert list_stack_resources_result == expected_list_stack_resources_result
...
def test_without_next_token_none():
    ...
    boto_list_stack_resources_result = {"StackResourceSummaries": []}
    list_stack_resources_result = ListStackResourcesResult.from_boto(
        boto_list_stack_resources_result
    )
    assert list_stack_resources_result == expected_list_stack_resources_result
